...
from app.core.alert_config import AlertConfig, AlertRule, AlertSeverity, AlertType, metrics_counter
...
class AlertMonitor:
    ...
    def check_security_events(self) -> Optional[AlertEvent]:
        ...
        security_count = metrics_counter.get_count_in_window(
            "security_warnings", rule.time_window_seconds
        )
    ...
    def check_auth_failures(self) -> Optional[AlertEvent]:
        ...
        auth_failure_count = metrics_counter.get_count_in_window(
            "auth_failures", rule.time_window_seconds
        )
    ...
    def check_performance(self) -> Optional[AlertEvent]:
        ...
        slow_requests = metrics_counter.get_count_in_window(
            "slow_requests", rule.time_window_seconds
        )
